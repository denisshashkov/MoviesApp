    ...
    <div class="movie-info-content">
      <b-row>
        ...
        <b-col sm="8">
          ...
          <div class="mt-3 mb-4">
            <b-badge class="movie-badge">{{ movie.Year }}</b-badge>
            <b-badge class="movie-badge">{{ movie.Runtime }}</b-badge>
            <b-badge class="movie-badge">{{ movie.Genre }}</b-badge>
            <b-badge class="movie-badge">{{ movie.Language }}</b-badge>
          </div>
...
export default {
  ...
  data: () => ({
    defaultPosterBg: "linear-gradient(45deg, #9a0204 0%, #200208 50%)",
  }),
  props: {
    movie: {
      type: Object,
...
.movie-info-header {
  ...
  padding: 1rem;
  color: #fff;
  background: linear-gradient(45deg, #9a0204 0%, #200208 50%);
}
